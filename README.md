...
You can download and run this project's "released" executable [RELEASE LINK](https://github.com/meyerdominik/MouseUnSnag/releases), or click on "release" in the GitHub GUI above.
